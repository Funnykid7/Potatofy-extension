...
// via the __potatofy_init CustomEvent, so they don't import this file.
...
// Settings shape used in popup display; everything must round-trip a boolean
// except numeric/array/object fields.
export const NUMERIC_SETTINGS = new Set(['idleThresholdMinutes', 'memoryPressureThresholdMB']);
export const NON_BOOLEAN_SETTINGS = new Set(['whitelist', 'potatoSites', ...NUMERIC_SETTINGS]);
